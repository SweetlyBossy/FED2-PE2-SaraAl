...
export function AuthProvider({ children }: { children: ReactNode }){
  ...
  const updateUserData = (data: { venueManager?: boolean; avatar?: { url: string; alt: string } }) => {
  ...
  return (
    <AuthContext.Provider value={{ user, accessToken, venueManager, isAuthenticated, login, logout, updateUserData }}>
      {children}
