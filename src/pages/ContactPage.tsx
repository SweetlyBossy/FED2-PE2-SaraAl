...
const ContactPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white font-inter pb-20">
      ...
      {/* Curved Hero Section (Reused from Create Venue for consistency) */}
      <div 
      ...
      {/* Main Content Area */}
      <div className="max-w-4xl mx-auto px-6 mt-16 text-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Location Card */}
          <div className="flex flex-col items-center p-8 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition-shadow text-center">
          ...
          <div className="flex flex-col items-center p-8 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition-shadow text-center">
            ...
            <a href="mailto:support@nordicstay.no" className="text-teal-600 font-semibold hover:underline mt-auto">
