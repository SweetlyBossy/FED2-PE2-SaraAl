...
const AboutPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white font-inter pb-20">
      ...
      {/* Main Content Area */}
      <div className="max-w-5xl mx-auto px-6 mt-16 text-slate-800">
        
        {/* Intro Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
          <div>
            <h2 className="text-3xl font-bold mb-6">Discover the extraordinary.</h2>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-teal-50 rounded-2xl -z-10"></div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          {/* Value 1 */}
          <div className="flex flex-col p-8 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-md transition-shadow">
