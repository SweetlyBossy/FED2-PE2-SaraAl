        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 pt-4">
            <div className="bg-white p-10 shadow-[0_0_40px_rgba(0,0,0,0.05)] border border-slate-100 rounded-lg space-y-10 relative overflow-hidden">
              ...
              <div className="absolute top-0 left-0 w-2 h-full bg-mint-green"></div>

              <div>
                <h2 className="text-3xl font-extrabold mb-2">Booking Confirmation</h2>
              ...
              <div>
                ...
                <ul className="space-y-6">
                  <li className="flex items-start">
                    <span className="text-mint-green text-xl mr-4 mt-1">✉️</span>
                    <p className="text-slate-700 text-lg">
                      A confirmation email has been sent to<br/>
                      <span className="font-semibold text-slate-900">
                        {state.contactEmail || user?.email || "your registered email"}
                      </span>
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="text-mint-green text-xl mr-4 mt-1">👤</span>
                    <p className="text-slate-700 text-lg">
            ...
            <div className="bg-white rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.08)] overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex justify-between text-slate-600 text-sm">
                  <span>Guests:</span>
                  <span className="font-semibold text-slate-900">{bookingData.guests} Adults</span>
                </div>
                ...
                <div className="flex justify-between text-slate-600 text-sm">
                  <span>Price:</span>
                  <span className="font-semibold text-slate-900">${venue.price}</span>
                </div>
