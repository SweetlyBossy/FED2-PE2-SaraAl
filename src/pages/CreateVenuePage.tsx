...
const CreateVenuePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      // The payload is structured to match the expected format of the API, with all necessary fields included. This allows us to successfully create a new venue with all the provided information.
      ...
      location: {
        // The location object contains the address of the venue, which is required by the API. This will be the address of the venue, as entered by the user in the form.
  ...
  return (
    <div className="min-h-screen bg-white font-inter pb-20" role="main">
      ...
      <div className="max-w-2xl mx-auto px-6 mt-12 text-black">
        {error && (
          <div
            className="bg-red-100 p-4 rounded text-red-600 text-center mb-6 border border-red-300"
            role="alert"
            aria-live="assertive"
          >
            {error}
        ...
        <form
          ...
          aria-label="Create venue form"
        >
          {/* SECTION 1: Venue Information */}
          <section aria-labelledby="section1-heading">
            <h2 id="section1-heading" className="text-xl font-bold mb-6">
              1. Venue Information
            </h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  name="description"
                  required
                  placeholder="Enter wanted description here"
          ...
          <section aria-labelledby="section2-heading">
            <h2 id="section2-heading" className="text-xl font-bold mb-4">
              2. Images
            </h2>
            <div className="space-y-6">
              <input
          ...
          <section aria-labelledby="section3-heading">
            <h2 id="section3-heading" className="text-xl font-bold mb-4">
              3. Contact
            </h2>
            <div>
              <label
          ...
          <section aria-labelledby="section4-heading">
            <h2 id="section4-heading" className="text-xl font-bold mb-4">
              4. Amenities
            </h2>
            <div
              ...
              {["wifi", "parking", "breakfast", "pets"].map((amenity) => (
                ...
                >
                  <input
                    ...
                    name={amenity}
                    checked={
                      formData.meta[amenity as keyof typeof formData.meta]
                    }
